        ...
        <div class="row mainwrapper">
            ...
            <div class="column block">
                <h5 class="bk-org title">
                    Home Work </h5>
                    <div class="DigitalTabs">

<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">

    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="pills-One-tab" data-bs-toggle="pill" data-bs-target="#pills-One" type="button" role="tab" aria-controls="pills-One" aria-selected="true">One</button>
    </li>

    <li class="nav-item" role="presentation">
      <button class="nav-link" id="pills-Two-tab" data-bs-toggle="pill" data-bs-target="#pills-Two" type="button" role="tab" aria-controls="pills-Two" aria-selected="false">Two</button>
    </li>

    <li class="nav-item" role="presentation">
      <button class="nav-link" id="pills-Three-tab" data-bs-toggle="pill" data-bs-target="#pills-Three" type="button" role="tab" aria-controls="pills-Three" aria-selected="false">Three</button>
    </li>

    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-Four-tab" data-bs-toggle="pill" data-bs-target="#pills-Four" type="button" role="tab" aria-controls="pills-Four" aria-selected="false">Four</button>
    </li>

    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-Five-tab" data-bs-toggle="pill" data-bs-target="#pills-Five" type="button" role="tab" aria-controls="pills-Five" aria-selected="false">Five</button>
    </li>

    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-Six-tab" data-bs-toggle="pill" data-bs-target="#pills-Six" type="button" role="tab" aria-controls="pills-Six" aria-selected="false">Six</button>
    </li>

    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-Seven-tab" data-bs-toggle="pill" data-bs-target="#pills-Seven" type="button" role="tab" aria-controls="pills-Seven" aria-selected="false">Seven</button>
    </li>

    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-Eight-tab" data-bs-toggle="pill" data-bs-target="#pills-Eight" type="button" role="tab" aria-controls="pills-Eight" aria-selected="false">Eight</button>
    </li>

    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-Nine-tab" data-bs-toggle="pill" data-bs-target="#pills-Nine" type="button" role="tab" aria-controls="pills-Nine" aria-selected="false">Nine</button>
    </li>

    <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-Ten-tab" data-bs-toggle="pill" data-bs-target="#pills-Ten" type="button" role="tab" aria-controls="pills-Ten" aria-selected="false">Ten</button>
    </li>
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade show active" id="pills-One" role="tabpanel" aria-labelledby="pills-One-tab">
        ...
        <div class="ClassRoutine table-responsive">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>22-07-2022</td>
                        <td>Online class by 22th July 2022</td>
                        <td>Bangla Alphabets</td>
                        <td>Video</td>
    ...
    <!-- nine -->
    <div class="tab-pane fade" id="pills-Nine" role="tabpanel" aria-labelledby="pills-Nine-tab">
    ...
    <!-- ten -->
    <div class="tab-pane fade" id="pills-Ten" role="tabpanel" aria-labelledby="pills-Ten-tab">
        ...
        <div class="ClassRoutine table-responsive">
            ...
            <div class="column block">
                ...
                <p><iframe frameborder="0" height="250"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14606.811117937137!2d90.37441860000003!3d23.75797610000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bf5503de42ab%3A0x1f4f7d0b6e90a3be!2sAsad%20Gate!5e0!3m2!1sen!2sbd!4v1681028093237!5m2!1sen!2sbd"
                        width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade" style="border:0" width="720"></iframe></p>
                <p>
                    <a href="#" class="btn" style="display:block;text-align:center;width:100%;">বিস্তারিত</a>
                </p>
            </div>
            <style>
                #right-content .block {
    ...
    <div class="four columns right-side-bar" id="right-content">
        ...
        <div class="column block">
            ...
            <p style="text-align:center"><strong><span style="font-size:20px"><span
                            style="font-size:22px">{{@$item->messager_name}}</span><span
