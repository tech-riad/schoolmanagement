...
<section class="StudentList Result section_gaps pt-70 pb-110" style="padding-bottom:50px">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- StudentListHeader -->
            <div class="StudentListContent py-4 px-3">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>01</td>
                                    <td>
                                        <img src="../frontend_assets/images/avater.png" alt="">
                                    </td>
                                    <td>2000122</td>
                                    <td>01</td>
                                    <td>Cj shuvo</td>
                                ...
                                <tr>
                                    <td>01</td>
                                    <td>
                                        <img src="../male.png" alt="" width="60px">
                                    </td>
                                    <td>2000122</td>
                                    <td>01</td>
                                    <td>Cj shuvo</td>
