                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-about mt-40">
                        <div class="logo">
                            <a href="#">
                                @if($info)
                                <img height="50px" src="{{Config::get('app.s3_url').Helper::academic_setting()->image}}" alt="">
                                @endif</a>
                        </div>
                    ...
                    <div class="footer-address mt-40">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="cont">
                                    <p><a href="tel:{{@$getintouch->phone}}"><i class="fas fa-phone-alt"></i> {{@$getintouch->phone}}</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
...
@include('frontent.theme2.layouts.expired-modal')
