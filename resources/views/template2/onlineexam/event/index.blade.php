                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="mb-3">
                                <h4 class="card-title" style="color:rgba(0, 0, 0, 0.5)">Event</h4>
                                <p class="card-description">Event List </p>
                            </div>
                            <a href="" class="btn btn-primary mr-2" style="width: 175px;height: 34px;">Add New Event</a>
                        </div>
