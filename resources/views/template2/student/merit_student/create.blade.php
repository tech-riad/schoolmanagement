        ...
        <div class="card new-table">
            ...
            <div class="card-body">
                ...
                <form id="student-form" method="GET">
                    ...
                    <div class="row py-2">
                        <div class="col-md-3"><label for="student_roll">Student Roll</label>
                            <input type="number" id="student_roll" class="form-control" name="student_roll"> 
                        </div>
                    </div>
        ...
        <div>
            <div class="card new-table" id="table-card" style="display: none">
                <div class="card-body">
                    ...
                    <form action="{{route('meritstudent.store')}}" method="post">
                        @csrf
                        <div class="">
