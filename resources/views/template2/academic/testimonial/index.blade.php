        ...
        <div>
            <div class="card new-table" id="table-card" style="display: none">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('academic.testimonial.alldownload')}}" id="download-form" hidden method="post">
                        @csrf

                        <div id="testimonial-download-form" hidden>
                            {{-- data form ajax --}}
                  ...
                  $.ajax({
                    ...
                    success: (data) => {
                        ...
                        $.each(data.students,function(i,v){
                            ...
                            let viewBtn = `<a class="btn btn-info" href="/academic/testimonial/view/${v.id}"><i class="fa fa-eye"></i></a>`;
                            let dwnBtn = `<a class="btn btn-primary" href="/academic/testimonial/download-testimonial/${v.id}"><i class="fa fa-arrow-down"></i></a>`;
                            //console.log(v);
                            ...
                            $("#testimonial-download-form").append($value);
