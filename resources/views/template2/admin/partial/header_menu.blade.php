  ...
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="{{url('/dashboard')}}"><img class="img-fluid"
            src="{{asset('template2_asset/images/logo/logo.png')}}" alt=""></a></div>
    ...
    <div class="left-menu-header col">
      <ul>
        ...
        <li>
          <a target="_blank" href="{{route('index')}}"><i style="font-size:30px;" class="fas fa-globe"></i></a>
        </li>
      </ul>
    </div>
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menus">
        <li><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()"><i
              class="fas fa-maximize"></i></a></li>
        <li class="onhover-dropdown">
          <div class="bookmark-box"><i class="fas fa-star"></i></div>
        ...
        <li class="onhover-dropdown">
          <div class="notification-box"><i class="fas fa-bell"></i><span class="dot-animated"></span></div>
        ...
        <li class="onhover-dropdown">
          ...
          <ul class="chat-dropdown onhover-show-div">
            <li>
              <div class="media">
                <img class="img-fluid rounded-circle me-3"
                  src="https://laravel.pixelstrap.com/viho/assets/images/user/4.jpg" alt="">
                <div class="media-body">
            ...
            <li>
              <div class="media">
                <img class="img-fluid rounded-circle me-3"
                  src="https://laravel.pixelstrap.com/viho/assets/images/user/2.jpg" alt="">
                <div class="media-body">
        ...
        <li class="onhover-dropdown p-0">
          ...
          document.getElementById('logout-form').submit();" href="{{ route('logout') }}" ><i class="fas fa-sign-out-alt"></i>Log out</button>
