                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="Date" class="form-control" id="date" required name="date" value="{{$fees->date ?? @old('date')}}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="due_date" required name="due_date" value="{{$fees->due_date ?? @old('due_date')}}">
                                </div>
                            </div>
                        </div>
