                            ...
                            <div class="card ml-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="d-flex align-items-center align-self-start">
                                                <h3 class="mb-0 text-black" id="today_total_collection">
                                                    {{number_format($todayTotalCollection,2)}}</h3>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="icon icon-box-success ">
                            ...
                            <div class="card ml-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="d-flex align-items-center align-self-start">
                                                <h3 class="mb-0 text-black" id="today_income">
                                                    {{number_format($todayTotalCollection,2)}}</h3>
                                            </div>
                                        </div>
                                        <div class="col-3">
                            ...
                            <div class="card ml-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="d-flex align-items-center align-self-start">
                                                <h3 class="mb-0 text-black" id="today_expense">
                                                    {{number_format($todayExpense,2)}}</h3>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="icon icon-box-success ">
            ...
            <div class="card">
                <div class="card-header" style="background-color:#fffefe">
                    <div class="d-flex">
                        <select class="form-control" name="session_id" id="session_id">
                            <option value="">Select Session</option>
                            @foreach ($sessions as $session)
                            <option value="{{$session->id}}" {{$currentYear == $session->title? 'selected':'' }}>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2"><div class="card ml-2">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                        <div class="d-flex align-items-center align-self-start">
                            ...
                            <div class="card ml-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="d-flex align-items-center align-self-start">
                                                <h3 class="mb-0 text-black" id="total_income">
                            ...
                            <div class="card ml-2">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="d-flex align-items-center align-self-start">
                                                <h3 class="mb-0 text-black" id="total_expense">
