                            ...
                            @include('custom-blade.search-student2')
                                <div class="card d-none"  id="subject-list">
                                    <div class="card-body">
                                       ...
                                       <center><u>Input Your Marks Subject Wise</u><br></center> 
                                    <div class="row">
                    ...
                    function(data){
                        ...
                        if(data.length == 0){
                           ...
                           if (doneSubjects.length = 0) {
                            let doneHtml = '<table class="table table-bordered" style="width:70%;"><thead><tr><th>Action</th><th>Subject Name</th><th>Total Student</th><th> Execel</th></tr></thead><tbody>';
                            $.each(doneSubjects,function (idx,val){
                            doneHtml += `<tr><td><input type="radio" name="subject_id" id="inlineRadio1${val.id}" value="${val.id}"></td><td>${val.sub_name}</td><td>-</td><td><a herf="#" class="btn btn-primary mt-3"><i class="fa fa-arrow-down"></i></a></td></tr>`;
                            });
                            ...
                            let pendingHtml = '<table class="table table-bordered sub-table" style="width:70%;"><thead><tr><th>Action</th><th>Subject Name</th><th>Total Student</th><th> Execel</th></tr></thead><tbody>';
                            $.each(pendingSubjects,function (idx,val){
                            pendingHtml += `<tr><td align="center"><input type="radio" name="subject_id" id="inlineRadio1${val.id}" value="${val.id}"></td><td>${val.sub_name}</td><td>-</td><td><a href="#" ><i class="fa  fa-file-excel"></i></a></td></tr>`;
                            });
