...
@section('content')
    <div class="main-panel">
        ...
        <div class="card new-table">
            <div class="card-body">
                {{-- <a href="{{route('academic.number-sheet.create')}}" class="btn btn-primary float-right">Create Number Sheet</a> --}}
                <h6>Transcript</h6>
                <hr>
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        ...
                        $.each(data.students,function(i,v){
                            ...
                            let viewBtn = `<a class="btn btn-info" target="_blank" href="/exam-management/transcript/${v.id}/${exam_id}/view"><i class="fa fa-eye"></i></a>`;
...
@endpush
>>>>>>> b747012854b837bf3856db287ce1f68386fbe2f0
