...
{{-- Config::get('app.s3_url').Helper::academic_setting()->image --}}
<body>
    <div style="width:395px; margin: auto;height:auto; padding: 10px;margin-top:10px;">
    <div style="width:395px;height:auto;float:left;margin-bottom:-40px;">
        <table style="width: 100%;">
          <td style="position: relative;">
            <img src="{{Helper::academic_setting()->image ? Config::get('app.s3_url').Helper::academic_setting()->image : asset('logo.jpg')}}" style="position: absolute; top: 10px; left: 20px; width: 50px; height: 50px;">
