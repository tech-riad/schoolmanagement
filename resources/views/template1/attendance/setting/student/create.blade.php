            ...
            <div class="card new-table">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="card-title" style="color:rgba(0, 0, 0, 0.5)">Students's Time Setting</h4>
                        </div>
                        {{-- data-toggle="modal" data-target="#exampleModal" --}}
                        <a href="{{ route('attendance.studenttime.index') }}" class="btn btn-primary mr-2 mb-2"
                            style="width: 200px;height: 34px;">Student's Time List
                        ...
                        <form id="teacher-form" method="POST">
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control js-example-basic-multiple" name="ins_class_id[]" multiple="multiple" id="class_id" style="width:100%;">
                    ...
                    <div class="row" id="table-card" style="display: none">
                        <div class="col-md-12">
                            <div class="card">
                                <form action="{{ route('attendance.studenttime.store') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
...
@push('js')
    ...
    <script>
            ...
            $('#teacher-form').submit(function(e) {
                ...
                var form = $(this);
                var url = "{{ route('attendance.studenttime.get-classes') }}";
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            $.each(data, function(i, value){
                                indexArray.push(i);
                                html += `<tr>
                                            <input type="hidden" name="ins_class_id[]" value="${value.id}" />
                                            <td scope="col">
