            ...
            <div class="card new-table">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <a href="{{ route('staff.export') }}" class="btn btn-success float-right"><i class="fa fa-file-excel"></i>
                                Export Excell</a>
                            <a href="{{ route('staff.create') }}" class="btn btn-primary mr-2 float-right" ><i class="fa fa-plus"></i> Add New</a>
                        </div>
                    </div>
                    <div class="card-body">
