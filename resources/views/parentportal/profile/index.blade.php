                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="old-password" id="old-password" class="form-control">
                                </div>
                                <div class="form-group">
...
<script>
        ...
        $('#image-upload').submit(function(e) {
            e.preventDefault();
            var url = "{{ route('student.profile.update', $student->id) }}";
        ...
        $("#division_id").on('change',function(){
            $("#district_id").empty();
            var id = $(this).val();
            var url = '/student-portal/get-district/'+id;
            $.ajax({
                url     : url,
                type    : 'GET',
        ...
        $("#district_id").on('change',function(){
            $("#upazila_id").empty();
            var id = $(this).val();
            var url = '/student-portal/get-upazila/'+id;
            $.ajax({
                url     : url,
                type    : 'GET',
                success : function(response){
        ...
        $('#cng-password').click(function(e){
            ...
            if(password != cpassword){
                ...
                $('#match-error').html('');
                $.post("{{route('student-portal.change-password')}}",{old_password,student_id,password},
                function(data){
